...
namespace CardBased
{
    public class CsvReader
    {
        ...
        public void LoadTable ( )
        {
            ...
            ReadTable (GameAsst.Inst.playerDataPath);
            ReadTable (GameAsst.Inst.enemyDataPath);
            ReadTable (GameAsst.Inst.gamelvDataPath);
            ReadTable (GameAsst.Inst.cardWrrDataPath);
            Debug.Log ("LoadTable...");
        }
